...
@dataclass
# this decorator helps us to define our class variables without a __init__() method
# if we have methods in the class dont use this decorator
class DataIngestionConfig:
    train_data_path: str=os.path.join('artifacts',"train.csv")
    #The resulting path would be 'artifacts/train.csv'
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        # we can provide code in here to read data from multiple sources
        logging.info("Entered the data ingestion method")
        try:
            df = pd.read_csv('notebook\data_source\student_data.csv')
