...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        This function is responsible for data tranformation based on the different types of data
        '''
        try:
            ...
            #Combaining the above piplines using the ColumTransformer
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            It is a convenient shorthand for concatenating arrays column-wise.
            """
